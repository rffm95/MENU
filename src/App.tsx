                    ...
                    <div className="flex p-4 md:p-6 gap-4 md:gap-6">
                      ...
                      <div className="flex-1 flex flex-col justify-between py-1">
                        <div className="min-w-0">
                          <div className="flex justify-between items-start mb-1 md:mb-2 gap-2 pr-2">
                             ...
                             <span className="text-jd-gold font-black text-xl md:text-2xl font-sport tracking-tighter italic shrink-0 mt-1 md:mt-1">€{item.price.toFixed(2)}</span>
                          </div>
